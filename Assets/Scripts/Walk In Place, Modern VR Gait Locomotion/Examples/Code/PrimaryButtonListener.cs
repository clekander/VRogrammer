...
public class PrimaryButtonListener : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (m_canChange && tempState != lastButtonState) // Button state changed since last frame
        {
    ...
    private IEnumerator CanChangeCO()
    {
